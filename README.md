...
[![](https://img.shields.io/badge/License-MIT-F77E70?style=for-the-badge)](https://github.com/theNewFlesh/jupyterlab_hotkeys/blob/master/LICENSE)
[![](https://img.shields.io/pypi/pyversions/jupyterlab_hotkeys?style=for-the-badge&label=Python&color=A0D17B&logo=python&logoColor=A0D17B)](https://github.com/theNewFlesh/jupyterlab_hotkeys/blob/master/docker/config/pyproject.toml)
[![](https://img.shields.io/pypi/v/jupyterlab_hotkeys?style=for-the-badge&label=PyPI&color=5F95DE&logo=pypi&logoColor=5F95DE)](https://pypi.org/project/jupyterlab_hotkeys/)
[![](https://img.shields.io/pypi/dm/jupyterlab_hotkeys?style=for-the-badge&label=Downloads&color=5F95DE)](https://pepy.tech/project/jupyterlab_hotkeys)
...
See [documentation](https://theNewFlesh.github.io/jupyterlab_hotkeys/) for details.
...
3. `git clone git@github.com:theNewFlesh/jupyterlab_hotkeys.git`
4. `cd jupyterlab_hotkeys`
5. `chmod +x bin/jupyterlab_hotkeys`
6. `bin/jupyterlab_hotkeys docker-start`
   - If building on a M1 Mac run `export DOCKER_DEFAULT_PLATFORM=linux/amd64` first.

The service should take a few minutes to start up.

Run `bin/jupyterlab_hotkeys --help` for more help on the command line tool.
...
# Change directory to the jupyterlab_hotkeys directory
...
```bash
pip uninstall jupyterlab_hotkeys
```

In development mode, you will also need to remove the symlink created by `jupyter labextension develop`
command. To find its location, you can run `jupyter labextension list` to figure out where the `labextensions`
folder is located. Then you can remove the symlink named `@theNewFlesh/jupyterlab_hotkeys` within that folder.

### ZSH Setup
1. `bin/jupyterlab_hotkeys` must be run from this repository's top level directory.
2. Therefore, if using zsh, it is recommended that you paste the following line
    in your ~/.zshrc file:
    - `alias jupyterlab_hotkeys="cd [parent dir]/jupyterlab_hotkeys; bin/jupyterlab_hotkeys"`
...
4. Running the `zsh-complete` command will enable tab completions of the cli
   ...
   For example:
   - `jupyterlab_hotkeys [tab]` will show you all the cli options, which you can press
     tab to cycle through
   - `jupyterlab_hotkeys docker-[tab]` will show you only the cli options that begin with
     "docker-"

# Installation for Production

### Python
`pip install jupyterlab_hotkeys`

### Docker
1. Install [docker-desktop](https://docs.docker.com/desktop/)
2. `docker pull theNewFlesh/jupyterlab_hotkeys:[mode]-[version]`
...
# Development CLI
bin/jupyterlab_hotkeys is a command line interface (defined in cli.py) that
...
Its usage pattern is: `bin/jupyterlab_hotkeys COMMAND [-a --args]=ARGS [-h --help] [--dryrun]`
